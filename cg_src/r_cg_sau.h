...
Macro definitions
***********************************************************************************************************************/
#define _B400_SAU_CH1_BAUDRATE_DIVISOR          (0xB400U) /* transfer clock set by dividing the operating clock */
#define _B400_SAU_CH2_BAUDRATE_DIVISOR          (0xB400U) /* transfer clock set by dividing the operating clock */
